...
public class Identificador
{
    public SolicitacaoDto IdentificarRecursoSolicitado(PathString rota, IConfiguration configuracoes)
    {
        ...
        {
            Log.Warning(
                "Há parâmetros de rota configurados para esse recurso, mas não foram enviados corretamente na requisição");
            return null;
        }
    ...
    private Dictionary<string, string> ObterParametrosRota(
        IReadOnlyList<string> nomesParametrosRota,
        IReadOnlyList<string> valoresParametrosRota)
    {
